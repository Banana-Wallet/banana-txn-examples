...
function App() {
  ...
  const createInstanceForMumbai = () => {
    const instance = new Banana(Chains.mumbai, paymasterOptions);
    setBananaInstance(instance);
  };

  const createInstanceForOptGoerli = () => {
    const instance = new Banana(Chains.optimismTestnet, paymasterOptions);
    setBananaInstance(instance);
  };

  const createInstanceForAstar = () => {
    const instance = new Banana(Chains.astar, paymasterOptions);
    setBananaInstance(instance);
  };
